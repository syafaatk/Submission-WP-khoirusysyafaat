...
export const StyleColorSocialLinkedin = ({
  color = "#0077B5",
  opacity = "unset",
  fill = "white",
  className,
  ...
  return (
    <svg
      className={`style-color-social-linkedin ${className}`}
      fill="none"
      height="32"
      viewBox="0 0 32 32"
      width="32"
    ...
    >
      ...
      <path
        ...
        fill={fill}
      />
      <path className="path" d="M11.307 13.252H7.68109V24.1464H11.307V13.252Z" fill={fill} />
      <path
        className="path"
